...
import com.hdw.entity.ColumnEntity;
import com.hdw.entity.TableEntity;
...
//        templates.add("template/mybatisPlus3/add-or-update.vue.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("Mapper.xml.vm" )) {
            return packagePath + "mapper" + File.separator +"sqlMapperXml"+File.separator+className + "Mapper.xml";
        }
