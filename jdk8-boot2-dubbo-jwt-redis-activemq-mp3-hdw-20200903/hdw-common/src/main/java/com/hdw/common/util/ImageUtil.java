...
public final class ImageUtil {
     ...
     * @param destHeight
     */
    public static void cutImage(InputStream is, File dirImageFile, int x, int y, int destWidth,
                                int destHeight) {
        try {
            Image img;
    ...
    public static String convertImageToByte(String imagePath, String format) {
        ...
        try {
            ...
            result = EncodeUtil.encodeBase64(bytes).trim();
        } catch (IOException e) {
        } finally {
            bi = null;
            try {
    ...
    public static void convertByteToImage(String base64String, String imagePath, String format) throws Exception {
        ...
        File file = null;
        try {
            bytes = EncodeUtil.decodeBase64(base64String);
